...
patients_of_the_day = [
    {"name": "Max Mustermann",
     ...
     "photo": "team3_msg/frontend/backend/dummy_patients/max.png",
     "data_file": "team3_msg/frontend/backend/dummy_patients/dummy_max.json",
     "appointment_time": "2024-06-25 08:30"},
    {"name": "John Doe",
     "insurance_number": "YYYYY",
      "photo": "team3_msg/frontend/backend/dummy_patients/john.jpg",
       "data_file": "team3_msg/frontend/backend/dummy_patients/dummy_john.json",
